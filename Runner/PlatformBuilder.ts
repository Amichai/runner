...
class platformBuilder {
    constructor(ctx: any) {
        ...
        this.tiles = [];
        this.tiles.push(new tile(this.path + 'fan.png',
            tile.tile6level, 576, 144, 150));
        this.tiles.push(new tile(this.path + 'tile1.png',
            tile.tile6level, 144, 144, 216));
        this.tiles.push(new tile(this.path + 'tile2.png',
            tile.tile6level, 576, 360, 0));
        this.tiles.push(new tile(this.path + 'tile3.png',
            tile.tile6level, 576, 360, 0));
        this.tiles.push(new tile(this.path + 'tile4.png',
            tile.tile6level, 576, 360, 0));
        this.tiles.push(new tile(this.path + 'tile5.png',
            tile.tile6level,  576, 360, 0));
        this.tiles.push(new tile(this.path + 'tile6.png',
            tile.tile6level, 576, 360, 0));
        this.tiles.push(new tile(this.path + 'tile7.png',
            tile.tile7level, 576, 360, 0));
        this.count = 0;
        this.section = new section1(this.ctx, this.tiles);
    }


    public getPlatformLevel() : number {
...
class tile {
    constructor(path: string, levelData : string, width: number, height: number, yOff: number) {
        this.imgPath = path;
        this.img = new Image();
        this.img.src = path;
        this.width = width;
    ...
    public getPlatformLevel(idx: number): number {
